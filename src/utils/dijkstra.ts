 ...
 * It can be more typization...but it doesnt make much sense
 */
...
const buildPrecedentsMap = (graph: any, startNode: any, endNode: any) => {
  ...
  const precedentsMap: Record<any, any> = {}

  // store nodes already visited
  const visited: Record<any, any> = {}
  ...
  const storedShortestPaths: Record<any, any> = {}
  ...
  const pQueue = new BinaryHeap(function (n: any) {
    return n.weight
  })
